...
`print(citation("projpredLeafMiner"), bibtex = TRUE)` within R.]. Further references
...
vignettes can be accessed offline by typing `browseVignettes("projpredLeafMiner")` within
