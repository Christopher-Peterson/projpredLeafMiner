...
For details on how to cite **projpred**, see the [projpred citation info](https://CRAN.R-project.org/package=projpred/citation.html) on CRAN^[The citation information can be accessed offline by typing `print(citation("projpredLeafMiner"), bibtex = TRUE)` within R.].
...
```{r data}
data("df_gaussian", package = "projpredLeafMiner")
